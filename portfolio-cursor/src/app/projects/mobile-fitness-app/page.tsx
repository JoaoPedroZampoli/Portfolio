...
export default function MobileFitnessAppPage() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="mb-8">
          <Image
            ...
            priority
          />
          <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-emerald-500 text-transparent bg-clip-text">Mobile Fitness App</h1>
          <p className="text-gray-300 mb-4">
            Aplicativo móvel para acompanhamento de exercícios, dieta e progresso com integração de wearables.
          </p>
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">React Native</span>
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">Firebase</span>
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">Redux</span>
          </div>
