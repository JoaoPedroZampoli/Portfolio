      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="mb-8">
          <Image
            ...
            priority
          />
          <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-emerald-500 text-transparent bg-clip-text">Social Media Dashboard</h1>
          <p className="text-gray-300 mb-4">
            Dashboard interativo para análise de métricas de redes sociais com gráficos em tempo real e relatórios personalizados.
          </p>
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">Next.js</span>
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">TypeScript</span>
            <span className="px-3 py-1 bg-gray-800 text-gray-200 rounded-full text-sm">Tailwind CSS</span>
          </div>
