...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/JoaoPedroZampoli',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 py-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center justify-center space-y-6">
            ...
            <div className="text-center text-gray-500 text-sm">
              <p>© {currentYear} João O. Pedro Zampoli. Todos os direitos reservados.</p>
              <p className="mt-2">
                Desenvolvido com{' '}
