  ...
  const projects = [
    {
      title: "ProjetoCEGI",
      description:
        "Projeto de Programação de Jogos na Unity Engine (C#) desenvolvido durante o curso do CEGI-Unifesp",
    ...
    },
    {
      ...
      description:
        "Software para melhoria e adequação do transporte público metropolitano para usuários PcD",
    ...
    },
    {
      ...
      description:
        "Modelos, diagramas e códigos desenvolvidos durante a disciplina de Banco de Dados",
  ...
  return (
    <section className="flex flex-col items-center justify-center">
      ...
      <div className="min-h-screen w-full p-16 flex items-center justify-center relative overflow-hidden">
        ...
        <motion.div
          className="w-full max-w-6xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16 relative z-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
              ...
              >
                <p>
                  ...
                  <span className="text-primary font-semibold">
                    Ciência e Tecnologia com ênfase em Ciência da Computação
                  </span>{" "}
                  na Unifesp, apaixonado por tecnologia e desenvolvimento de
                  software.
                </p>
                <p>
                  Participando ativamente de projetos de extensão universitária
                  focados em{" "}
                ...
                <CardBody className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech) => (
                      <Chip key={tech} size="sm" variant="dot" color="primary">
                        {tech}
                      </Chip>
                    ))}
                  </div>
